...
data_lake_name = "s3a://goes-se-sandbox01/" # s3a://goes-se-sandbox01/
s3BucketName = "s3a://goes-se-sandbox01/tmp/tsimon-oceanrace" # currently: s3a://goes-se-sandbox01/tmp/tsimon-oceanrace

username = "tsimon" # add your username here to create different database than other users
